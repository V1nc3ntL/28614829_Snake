 ...
 */
void
connectToServer (char *serverName, int port, char *name)
{
 ...
 */
void
waitForSnakeGame (char *gameType, char *gameName, int *sizeX, int *sizeY,
		  int *nbWalls)
{
  char data[128];
  /* wait for a game */
